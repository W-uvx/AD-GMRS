...
- Optional R package `INTACT` for evidence-weighted TRS/ProRS aggregation
...
When unset, features are equally weighted. When set, every selected feature must
be present and INTACT-derived weights are stored in the fitted model.
